...
#Read the dataset----
titanic<-read.csv("D:/Anaytics Skill edge practicals/Case_ Study_1_Decision Tree_Project/titanic.csv",header = T)
...
#Convert few continuos var from factor to numeric----
