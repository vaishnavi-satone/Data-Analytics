...
#Read the dataset
data <- read.csv("D:/Anaytics Skill edge practicals/22 - RandomForest_Project.R/heart-disease.csv",header=TRUE)
...
#106+25/224(training dataset observations)
#187/224
...
#34+29/75(testing dataset observations)
...
#please Note:
# the accuracy of random forest on training dataset is 83%.
#and the accuracy of random forest on test dataset is 84%.
#Since the prediction on both dataset is almost comparable,
#hence there is no Overfitting in this model.
#Therefore model build is a good model.
