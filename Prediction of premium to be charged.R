...
#----Read the dataset------
getwd()
setwd("D:/Anaytics Skill edge practicals/18 - Multiple Regression Project")
Plan_Dataset <- read.csv("D:/Anaytics Skill edge practicals/18 - Multiple Regression Project/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
setwd("D:/Anaytics Skill edge practicals/18 - Multiple Regression Project")
sm2 <- read.csv("D:/Anaytics Skill edge practicals/18 - Multiple Regression Project/InsurancePlanSubscriptions-2018.csv")
View(sm2)
