...
#like c1, c2, c3, c4, c5
write.csv(x=mtcars, file='D:/Anaytics Skill edge practicals/14 - Data Extraction in R/mtcars1.csv')
write.csv(x=mtcars, file='D:/Anaytics Skill edge practicals/14 - Data Extraction in R/mtcars2.csv', row.names = F)
