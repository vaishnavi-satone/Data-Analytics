#Regression
df <- read.csv("D:/Anaytics Skill edge practicals/17 -Linear and Multiple Regression in R/stud_reg.csv", header = T)
View(df)
df
...
#eg: mpq = 9.6 - 3.91*wt +1.21*qsec +2.93*am

#Value of Adjusted R2 = 0.84, 
#means that "84% of the variance in the measure of mpg can be predicted by hp and wt."
...
#however R2 is not reliable parameter to evaluatethe accuracy of the model
