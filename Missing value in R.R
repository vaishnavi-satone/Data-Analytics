...
df_titanic <- read.csv(file = "D:/Anaytics Skill edge practicals/15 - Missing value in R/TitanicDataMissingValues.csv")
...
# Return the row names containing missing observations
list_na <- rownames(df_titanic)[ apply(df_titanic, 1, anyNA) ]
list_na
